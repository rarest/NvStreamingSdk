#
#  Be sure to run `pod spec lint NvStreamingSdk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # https://github.com/rarest/NvStreamingSdk Popular ones are 'MIT', 'BSD' and 'Apache License, Version 2.0'.
  #
  ...
  # Or just: s.author    = "rarest"
  # s.authors            = { "rarest" => "wich@163.com" }
  # s.social_media_url   = "http://twitter.com/rarest"
